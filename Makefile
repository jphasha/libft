...
#    Updated: 2019/06/12 15:49:00 by jphasha          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SOURCES = ft_isalnum.c ft_isalpha.c ft_isascii.c ft_isdigit.c ft_isprint.c \
		  ...
		  ft_memset.c ft_memmove.c ft_bzero.c ft_atoi.c ft_strnew.c
...
OBJECTS = ft_isalnum.o ft_isalpha.o ft_isascii.o ft_isdigit.o ft_isprint.o \
		  ...
		  ft_memset.o ft_memmove.o ft_bzero.o ft_atoi.o ft_strnew.o
