...
#    Updated: 2019/06/04 17:31:26 by jphasha          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SOURCES = ft_isalnum.c ft_isalpha.c ft_isascii.c ft_isdigit.c ft_isprint.c \
		  ...
		  ft_strdup.c ft_strstr.c ft_strnstr.c ft_strchr.c ft_strrchr.c
...
OBJECTS = ft_isalnum.o ft_isalpha.o ft_isascii.o ft_isdigit.o ft_isprint.o \
		  ...
		  ft_strdup.o ft_strstr.o ft_strnstr.o ft_strchr.o ft_strrchr.o
