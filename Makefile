...
#    Updated: 2019/08/24 15:37:11 by jphasha          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SOURCES = ft_isalnum.c ft_isalpha.c ft_isascii.c ft_isdigit.c ft_isprint.c \
		  ...
		  ft_word_cmp.c ft_print_hex.c ft_lstdel.c ft_lstdelone.c
...
OBJECTS = ft_isalnum.o ft_isalpha.o ft_isascii.o ft_isdigit.o ft_isprint.o \
		  ...
		  ft_word_cmp.o ft_print_hex.o ft_lstdel.o ft_lstdelone.o
